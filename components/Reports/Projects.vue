  ...
  switch (filters.status.toLowerCase()) {
    ...
    case "patvirtintas":
      filteredTemp = filteredTemp.filter(
        (project) => project.status.toLowerCase() === "patvirtintas",
      );
      break;
    case "betonuojama":
      filteredTemp = filteredTemp.filter(
        (project) => project.status.toLowerCase() === "betonuojama",
      );
      break;
    case "montuojama":
      filteredTemp = filteredTemp.filter(
        (project) => project.status.toLowerCase() === "montuojama",
      );
      break;
    case "laukiam vartų":
      filteredTemp = filteredTemp.filter(
        (project) => project.status.toLowerCase() === "laukiam vartų",
      );
      break;
    case "pridavimas":
      filteredTemp = filteredTemp.filter(
        (project) => project.status.toLowerCase() === "pridavimas",
      );
      break;
    case "apmokėjimas":
      filteredTemp = filteredTemp.filter(
        (project) => project.status.toLowerCase() === "apmokėjimas",
      );
      break;
    case "lauko žaliuzės":
      filteredTemp = filteredTemp.filter(
        (project) => project.status.toLowerCase() === "lauko žaliuzės",
      );
      break;
    case "aktyvus":
      filteredTemp = filteredTemp.filter((project) => project.status.toLowerCase() !== "baigtas");
