...
<template>
  <div
    class="flex gap-20 items-start bg-red-ulta-light p-8 rounded-xl border border-dashed font-medium text-lg border-dark-light">
    ...
    <div class="flex flex-col gap-4 items">
      ...
      <div v-if="props.results.discount" class="flex gap-2 items-center ">
        Suma su nuolaida:
        <input type="number" class="bg-transparent w-24 px-2" :value="props.results.priceWithDiscount"
