...
<template>
  <div class="flex justify-center bg-dark-full py-8 text-white">
    <div class="w-[1200px]">
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="flex gap-2">
              <NuxtImg
                ...
                :ismap="true"
              />
              <p>Banko sąskaita: LT247300010158952845</p>
            </div>
          </div>
          <div class="flex flex-col gap-2">
