...
<template>
  <div class="flex flex-col gap-4">
    <div class="grid grid-cols-3 divide-y divide-x border-r border-b">
      <div class="p-2 border-l border-t">Pavadinimas</div>
      <div class="p-2">Pirma pamaina</div>
      <div class="p-2">Antra pamaina</div>
      <div class="p-2">Darbo laiko pradžia</div>
      <div>
      ...
      <div class="p-2">Darbo laiko pabaiga</div>
      <div>
      ...
      <div class="p-2">Pjovimo staklių tikslas</div>
      <div>
      ...
      <div class="p-2">Lenkimo staklių 1 tikslas</div>
      <div>
      ...
      <div class="p-2">Lenkimo staklių 2 tikslas</div>
      <div>
      ...
      <div class="p-2">Skylučių mušimo staklių tikslas</div>
      <div>
    ...
    <div class="flex flex-col gap-4">
      <div class="grid border-l grid-cols-3">
        <div class="p-2 border-y">Skylučių mušimo indeksas</div>
        <div class="p-2 border">
          <input v-model.number="settingStore.reportsGeneral.holesIndex" type="number" />
        </div>
        <div></div>

        <div class="p-2 border-b">Gamybos savikaina</div>
        <div class="p-2 border-x border-b flex justify-between">
