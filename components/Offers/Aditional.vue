<template>
  <OffersBoxWrap>
    <div class="font-bold text-2xl text-center">Papildomos medžiagos ir paslaugos</div>
    <div class="flex gap-4 flex-wrap justify-center">
      <div class="flex flex-col">
        <div class="grid - h-fit border-2 rounded-md border-black">
          ...
          <div class="px-2 py-1 border-b border-inherit border-r">U formos profilis viengubas</div>
          <div class="px-2 py-1 border-b border-inherit border-r">1.21 €/m</div>
          <div class="px-2 py-1 border-b border-inherit">1.46 €/m</div>
          <div class="px-2 py-1 border-b border-inherit border-r">U formos profilis dvigubas</div>
          <div class="px-2 py-1 border-b border-inherit border-r">2.13 €/m</div>
          <div class="px-2 py-1 border-b border-inherit">2.58 €/m</div>
          ...
          <div class="px-2 py-1 border-inherit border-b border-r">Kniedės 4 x 8 mm</div>
          <div class="px-2 py-1 border-inherit border-b border-r">25 €/1000 vnt</div>
          <div class="px-2 py-1 border-inherit border-b">30.25 €/1000 vnt</div>
          <div class="px-2 py-1 border-inherit border-b border-r">Skylučių mušimas lankstiniui</div>
          <div class="px-2 py-1 border-inherit border-b border-r">0.24 ct/vnt</div>
      ...
      <div class="flex flex-col">
        <div class="grid grid-cols-[1.2fr_1fr_1fr] h-fit border-2 rounded-md border-black">
          ...
          <div class="px-2 py-1 border-b border-inherit border-r flex">Tvoros stulpo apkaustas</div>
          <div class="px-2 py-1 border-b border-inherit border-r flex">1.20 €/m</div>
