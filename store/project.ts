...
export const useProjectStore = defineStore("project", {
  ...
  getters: {
    updateClientAddress: (state) => (data: string): void => {
      state.client.address = data;
    },

    updateClientUsername: (state) => (data: string): void => {
      state.client.username = data;
    },

    updateClientPhone: (state) => (data: string): void => {
      state.client.phone = data;
    },

    updateClientEmail: (state) => (data: string): void => {
      state.client.email = data;
    },

    updateSide: (state) => (data: { index: number; value: string }): void => {
      state.fences[data.index].side = data.value;
    },

    updateType: (state) => (data: { index: number; value: string }): void => {
      state.fences[data.index].type = data.value;
    },

    updateColor: (state) => (data: { index: number; value: string }): void => {
    ...
    copyLast: (state) => (index: number): void => {
    ...
    deleteMeasures: (state) => (index: number): void => {
      state.fences[index].measures = [{ ...initialMeasure }];
    },

    deleteFence: (state) => (id: string): void => {
