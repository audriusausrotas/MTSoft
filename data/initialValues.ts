...
export const defaultValues = {
  ...
  border: "Tvoros pamatas 2500x200x60 mm (Baltas)",
  borderHolder: "Pamato laikiklis 200x60 mm",
  ...
  bindings: "Apkaustai",
  retailBindings: "Stulpo apkaustas centrinis metras",
  retailDoubleLeg: "U Profilis dvigubas metras",
  retailSingleLeg: "U profilis viengubas metras",
