...
export default defineEventHandler(async (event: any) => {
  ...
  <body>
      ...
      <br/>
      <br/>
      <p>Mes esame vieni didžiausių skardinių tvorų gamintojai Lietuvoje. Specializuojamos populiariausių tvorų modelių gamyboje. 
      ...
      <ol>
        ...
        <li>Lankstumas - tvoros gaminius galime pasiūlyti iš PREMIUM klasės skardos su 45m. garantija ir ECO variantą su 5m. plonesne skarda.</li>
        <li>Greitis - Gamybos terminas 7 d.d. reikalui esant galim pagaminti per 2 darbo dienas. Taip pat pristatome gaminius visoje Lietuvoje.</li>
      ...
      <br/>
      <br/>
      <a href="https://modernitvora.vercel.app/didmena/atsisakyti/${recipient._id}" style="font-size: large; font-weight: 500">Atsisakyti naujienlaikraščio</a>
  </body>
    </html>
  `;
